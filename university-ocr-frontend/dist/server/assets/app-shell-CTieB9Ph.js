import { a as cn, n as clearSession, r as getSession } from "./card-BscL139z.js";
import { n as Button, t as Input } from "./input-CgQKAJfB.js";
import * as React from "react";
import { useEffect, useState } from "react";
import { Link, useNavigate, useRouterState } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Bell, Building2, FileText, Files, GitBranch, LayoutDashboard, LogOut, PanelLeft, ScrollText, Search, Upload, Users, X } from "lucide-react";
...
var adminLinks = [
	...
	},
	{
		...
		url: "/audit",
		icon: ScrollText,
		roles: ["Super Administrator", "Department Administrator"]
	}
];
		...
		children: [
			/* @__PURE__ */ jsx(SidebarHeader, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						className: "size-8 rounded-md bg-sidebar-primary text-sidebar-primary-foreground grid place-items-center shrink-0",
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: "File Tracking"
						})]
					})]
				})
			}),
			/* @__PURE__ */ jsxs(SidebarContent, { children: [/* @__PURE__ */ jsxs(SidebarGroup, { children: [/* @__PURE__ */ jsx(SidebarGroupLabel, { children: "Workspace" }), /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: nav.map((i) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, {
				asChild: true,
				isActive: isActive(i.url),
				tooltip: i.title,
				children: /* @__PURE__ */ jsxs(Link, {
					to: i.url,
					children: [/* @__PURE__ */ jsx(i.icon, {}), /* @__PURE__ */ jsx("span", { children: i.title })]
				})
			}) }, i.url)) }) })] }), admin.length > 0 && /* @__PURE__ */ jsxs(SidebarGroup, { children: [/* @__PURE__ */ jsx(SidebarGroupLabel, { children: "Administration" }), /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: admin.map((i) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, {
				asChild: true,
				isActive: isActive(i.url),
				tooltip: i.title,
				children: /* @__PURE__ */ jsxs(Link, {
			...
			/* @__PURE__ */ jsx(SidebarFooter, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(Avatar, {
							className: "size-8",
							children: /* @__PURE__ */ jsx(AvatarFallback, { children: session.name.slice(0, 2).toUpperCase() })
						}),
						/* @__PURE__ */ jsxs("div", {
...
function AppShell({ title, subtitle, actions, children }) {
	...
	return /* @__PURE__ */ jsx(SidebarProvider, { children: /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(AppSidebar, { session }), /* @__PURE__ */ jsxs("div", {
			className: "flex-1 flex flex-col min-w-0",
			children: [/* @__PURE__ */ jsxs("header", {
				className: "h-14 border-b bg-card flex items-center gap-3 px-4 sticky top-0 z-10",
				children: [
